...
@Composable
fun ConfirmedSales(model: MainViewModel = viewModel(), navController: NavController) {
    val scrollState = rememberScrollState()
    val sales by model.confirmedSaleWatcher.observeAsState()
